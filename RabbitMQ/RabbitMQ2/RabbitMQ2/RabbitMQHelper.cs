...
namespace RabbitMQ2
{
    public class RabbitMQHelper
    {
        ...
        {
            HostName = ApplicationConfig.GetValue("RabbitMQ:Host"),
            UserName = ApplicationConfig.GetValue("RabbitMQ:UserName"),
            Password = ApplicationConfig.GetValue("RabbitMQ:Password"),
        };
